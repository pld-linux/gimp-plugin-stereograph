...
Summary(pl):	Wtyczka do tworzenia stereogramów dla GIMP-a
...
%description -l pl
To jest wtyczka do GIMP-a u¿ywaj±ca interfejsu programu Stereograph,
generatora wysokiej jako¶ci pojedynczych obrazów stereogramowych (SIS)
